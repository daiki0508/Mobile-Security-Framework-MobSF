...
def get_secret_text_from_binary(app_type, src, bin_name):
    ...
    command2 = ['nuclei', '-file', '-t', home + 'nuclei-templates/file/keys/', '-t', home + 'nuclei-custom-templates/', '-et', home + 'nuclei-templates/file/keys/credential-exposure-file.yaml', '-je', app_dir + 'tmp.json']
